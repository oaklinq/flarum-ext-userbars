...
flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('kvothe-userbars', function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_components_CommentPost__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'footerItems', function (items) {
    var fiveRandomUserbars = getRandom(userbars, 5);
    items.add('signature', m('userbars', [fiveRandomUserbars.map(function (i) {
      return m('img.userbar', {
        src: i
      });
    })]));
  });
